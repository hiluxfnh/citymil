  ...
  <footer class="footer-distributed">
    ...
    <div class="footer-right">
      ...
      <div class="footer-icons">
        <a href="https://www.facebook.com/citymil" target="_blank"><i class="fab fa-facebook-f"></i></a>
        <a href="https://twitter.com/citymil" target="_blank"><i class="fab fa-twitter"></i></a>
        <a href="https://www.instagram.com/citymil/" target="_blank"><i class="fab fa-instagram"></i></a>
        <a href="https://www.youtube.com/channel/UCZ3Z6Z6Z2ZqQ4Z9XZ9Z9Z9Q" target="_blank"><i class="fab fa-youtube"></i></a>
      </div>
      <form>
        <select>
